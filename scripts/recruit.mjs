...
import characterTable from "./ArknightsGamedata/en/gamedata/excel/character_table.json" with { type: "json" };
import gachaTable from "./ArknightsGamedata/en/gamedata/excel/gacha_table.json" with { type: "json" };
